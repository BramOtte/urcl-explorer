...
import { Word } from "./emulator/util.js";
...
let input_callback: undefined | ((value: string) => boolean);
...
async function numb_in(): Promise<Word> {
    let number = NaN;
...
async function numb_out(value: Word): Promise<void> {
    console_output.innerText += value;
}

async function text_out(value: Word){
